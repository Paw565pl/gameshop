# Generated by Django 4.1.13 on 2024-01-17 15:17
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                "^[0-9]{9}$", "Phone number must be 9 digits."
                            )
                        ],
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(
                        ...
                        validators=[
                            django.core.validators.RegexValidator(
                                "^[0-9]{2}-[0-9]{3}$",
                                "Invalid post code. Correct format is XX-XXX.",
                            )
                        ],
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "payment_method",
                    models.CharField(
                        choices=[("BLIK", ""), ("PAYPAL", "")], max_length=10
                    ),
                ),
                (
                    "delivery_method",
                    models.CharField(
                        choices=[("INPOST", "Inpost"), ("DHL", "DHL")], max_length=10
                    ),
                ),
                (
                    "total_price",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    djongo.models.fields.ArrayReferenceField(
                        on_delete=djongo.models.fields.ArrayReferenceField._on_delete,
                        to="orders.supportticketmessage",
                    ),
                ),
                (
                    "order",
