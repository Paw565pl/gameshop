# Generated by Django 4.1.13 on 2023-12-10 15:18
            ...
            fields=[
                ...
                (
                    ...
                    djongo.models.fields.ArrayField(
                        default=[], model_container=games.models.Genre
                    ),
                ),
                (
                    "platforms",
                    djongo.models.fields.ArrayField(
                        default=[], model_container=games.models.Platform
                    ),
                ),
                (
                    "developers",
                    djongo.models.fields.ArrayField(
                        default=[], model_container=games.models.Developer
                    ),
                ),
                (
                    "screenshots",
                    djongo.models.fields.ArrayField(
                        default=[], model_container=games.models.Screenshot
                    ),
                ),
                (
                    "reviews",
                    djongo.models.fields.ArrayField(
                        default=[], model_container=games.models.Review
                    ),
                ),
            ],
        ),
